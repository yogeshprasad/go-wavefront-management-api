...
// WithBody adds the body to the create webhook params
func (o *CreateWebhookParams) WithBody(body *models.Notificant) *CreateWebhookParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create webhook params
func (o *CreateWebhookParams) SetBody(body *models.Notificant) {
	o.Body = body
}
