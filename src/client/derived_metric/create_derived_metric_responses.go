...
func (o *CreateDerivedMetricOK) Error() string {
	return fmt.Sprintf("[POST /api/v2/derivedmetric][%d] createDerivedMetricOK  %+v", 200, o.Payload)
}
...
func (o *CreateDerivedMetricOK) GetPayload() *models.ResponseContainerDerivedMetricDefinition {
	return o.Payload
}
