...
func (o *CreateDerivedMetricParams) WithBody(body *models.DerivedMetricDefinition) *CreateDerivedMetricParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create derived metric params
func (o *CreateDerivedMetricParams) SetBody(body *models.DerivedMetricDefinition) {
	o.Body = body
}
