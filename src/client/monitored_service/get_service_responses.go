...
func (o *GetServiceOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/monitoredservice/{application}/{service}][%d] getServiceOK  %+v", 200, o.Payload)
}
...
func (o *GetServiceOK) GetPayload() *models.ResponseContainerMonitoredServiceDTO {
	return o.Payload
}
