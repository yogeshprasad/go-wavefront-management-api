...
// WithApplication adds the application to the get service params
func (o *GetServiceParams) WithApplication(application string) *GetServiceParams {
	o.SetApplication(application)
	return o
}

// SetApplication adds the application to the get service params
func (o *GetServiceParams) SetApplication(application string) {
