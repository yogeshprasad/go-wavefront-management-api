...
GetAWSExternalIDParams contains all the parameters to send to the API endpoint
	...
	for the get a w s external Id operation.
...
// WithDefaults hydrates default values in the get a w s external Id params (not the query body).
//
...
// SetDefaults hydrates default values in the get a w s external Id params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get a w s external Id params
func (o *GetAWSExternalIDParams) WithTimeout(timeout time.Duration) *GetAWSExternalIDParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get a w s external Id params
func (o *GetAWSExternalIDParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get a w s external Id params
func (o *GetAWSExternalIDParams) WithContext(ctx context.Context) *GetAWSExternalIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get a w s external Id params
func (o *GetAWSExternalIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get a w s external Id params
func (o *GetAWSExternalIDParams) WithHTTPClient(client *http.Client) *GetAWSExternalIDParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get a w s external Id params
func (o *GetAWSExternalIDParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithID adds the id to the get a w s external Id params
func (o *GetAWSExternalIDParams) WithID(id string) *GetAWSExternalIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get a w s external Id params
func (o *GetAWSExternalIDParams) SetID(id string) {
	o.ID = id
}
