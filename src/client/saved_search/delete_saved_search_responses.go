...
func (o *DeleteSavedSearchOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v2/savedsearch/{id}][%d] deleteSavedSearchOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSavedSearchOK) GetPayload() *models.ResponseContainerSavedSearch {
	return o.Payload
}
