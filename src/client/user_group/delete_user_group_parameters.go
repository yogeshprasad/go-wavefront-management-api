...
// WithID adds the id to the delete user group params
func (o *DeleteUserGroupParams) WithID(id string) *DeleteUserGroupParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete user group params
func (o *DeleteUserGroupParams) SetID(id string) {
	o.ID = id
}
