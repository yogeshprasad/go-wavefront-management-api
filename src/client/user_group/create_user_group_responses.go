...
func (o *CreateUserGroupOK) Error() string {
	return fmt.Sprintf("[POST /api/v2/usergroup][%d] createUserGroupOK  %+v", 200, o.Payload)
}
...
func (o *CreateUserGroupOK) GetPayload() *models.ResponseContainerUserGroupModel {
	return o.Payload
}
