...
func (o *DefaultAppMapSearch3OK) Error() string {
	return fmt.Sprintf("[POST /api/v2/savedtracessearch/defaultTracesSearch][%d] defaultAppMapSearch3OK  %+v", 200, o.Payload)
}
...
func (o *DefaultAppMapSearch3OK) GetPayload() *models.ResponseContainerString {
	return o.Payload
}
