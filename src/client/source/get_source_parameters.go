...
// WithID adds the id to the get source params
func (o *GetSourceParams) WithID(id string) *GetSourceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get source params
func (o *GetSourceParams) SetID(id string) {
	o.ID = id
}
