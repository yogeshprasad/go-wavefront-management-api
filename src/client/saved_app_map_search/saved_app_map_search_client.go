...
type ClientService interface {
	...
	DefaultAppMapSearch2(params *DefaultAppMapSearch2Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DefaultAppMapSearch2OK, error)
...
/*
DefaultAppMapSearch1 gets default app map search for a user
*/
...
/*
DefaultAppMapSearch2 sets default app map search at user level
*/
func (a *Client) DefaultAppMapSearch2(params *DefaultAppMapSearch2Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DefaultAppMapSearch2OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDefaultAppMapSearch2Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "defaultAppMapSearch_2",
		Method:             "POST",
		PathPattern:        "/api/v2/savedappmapsearch/defaultAppMapSearch",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DefaultAppMapSearch2Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DefaultAppMapSearch2OK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for defaultAppMapSearch_2: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
