...
// WithSkipTrash adds the skipTrash to the delete dashboard params
func (o *DeleteDashboardParams) WithSkipTrash(skipTrash *bool) *DeleteDashboardParams {
	o.SetSkipTrash(skipTrash)
	return o
}

// SetSkipTrash adds the skipTrash to the delete dashboard params
func (o *DeleteDashboardParams) SetSkipTrash(skipTrash *bool) {
