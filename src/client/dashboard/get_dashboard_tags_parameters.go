...
// WithID adds the id to the get dashboard tags params
func (o *GetDashboardTagsParams) WithID(id string) *GetDashboardTagsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get dashboard tags params
func (o *GetDashboardTagsParams) SetID(id string) {
	o.ID = id
}
