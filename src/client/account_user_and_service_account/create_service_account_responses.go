...
func (o *CreateServiceAccountOK) Error() string {
	return fmt.Sprintf("[POST /api/v2/account/serviceaccount][%d] createServiceAccountOK  %+v", 200, o.Payload)
}
...
func (o *CreateServiceAccountOK) GetPayload() *models.ResponseContainerServiceAccount {
	return o.Payload
}
