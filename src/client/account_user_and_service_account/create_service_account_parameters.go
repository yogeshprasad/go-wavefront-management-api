...
func (o *CreateServiceAccountParams) WithBody(body *models.ServiceAccountWrite) *CreateServiceAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create service account params
func (o *CreateServiceAccountParams) SetBody(body *models.ServiceAccountWrite) {
	o.Body = body
}
