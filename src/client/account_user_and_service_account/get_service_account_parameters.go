...
// WithID adds the id to the get service account params
func (o *GetServiceAccountParams) WithID(id string) *GetServiceAccountParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get service account params
func (o *GetServiceAccountParams) SetID(id string) {
	o.ID = id
}
