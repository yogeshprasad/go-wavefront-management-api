...
func (o *UpdateUserAccountParams) WithBody(body *models.UserRequestDTO) *UpdateUserAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user account params
func (o *UpdateUserAccountParams) SetBody(body *models.UserRequestDTO) {
	o.Body = body
}

// WithID adds the id to the update user account params
func (o *UpdateUserAccountParams) WithID(id string) *UpdateUserAccountParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update user account params
func (o *UpdateUserAccountParams) SetID(id string) {
	o.ID = id
}
