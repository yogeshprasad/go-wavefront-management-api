...
type ClientService interface {
	...
	AddIngestionPolicy(params *AddIngestionPolicyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddIngestionPolicyOK, error)
	...
	RemoveIngestionPolicies(params *RemoveIngestionPoliciesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RemoveIngestionPoliciesOK, error)
...
/*
AddIngestionPolicy adds a specific ingestion policy to multiple accounts
*/
func (a *Client) AddIngestionPolicy(params *AddIngestionPolicyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddIngestionPolicyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAddIngestionPolicyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "addIngestionPolicy",
		Method:             "POST",
		PathPattern:        "/api/v2/account/addingestionpolicy",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AddIngestionPolicyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*AddIngestionPolicyOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for addIngestionPolicy: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
RemoveIngestionPolicies removes ingestion policies from multiple accounts
*/
func (a *Client) RemoveIngestionPolicies(params *RemoveIngestionPoliciesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RemoveIngestionPoliciesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewRemoveIngestionPoliciesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "removeIngestionPolicies",
		Method:             "POST",
		PathPattern:        "/api/v2/account/removeingestionpolicies",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &RemoveIngestionPoliciesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*RemoveIngestionPoliciesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for removeIngestionPolicies: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
