...
func (m *PolicyRuleReadModel) validateTags(formats strfmt.Registry) error {
...
func (m *PolicyRuleReadModel) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
