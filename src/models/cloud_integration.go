...
type CloudIntegration struct {
	...
	// Required: true
	// Enum: [CLOUDWATCH CLOUDTRAIL EC2 GCP GCPBILLING TESLA AZURE AZUREACTIVITYLOG NEWRELIC APPDYNAMICS VROPS SNOWFLAKE DYNATRACE]
...
func (m *CloudIntegration) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTesla(formats); err != nil {
		res = append(res, err)
	}
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["CLOUDWATCH","CLOUDTRAIL","EC2","GCP","GCPBILLING","TESLA","AZURE","AZUREACTIVITYLOG","NEWRELIC","APPDYNAMICS","VROPS","SNOWFLAKE","DYNATRACE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CloudIntegrationServiceTESLA captures enum value "TESLA"
	CloudIntegrationServiceTESLA string = "TESLA"
...
func (m *CloudIntegration) validateTesla(formats strfmt.Registry) error {
	if swag.IsZero(m.Tesla) { // not required
		return nil
	}

	if m.Tesla != nil {
		if err := m.Tesla.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("tesla")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("tesla")
			}
			return err
		}
	}
...
func (m *CloudIntegration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTesla(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CloudIntegration) contextValidateTesla(ctx context.Context, formats strfmt.Registry) error {

	if m.Tesla != nil {
		if err := m.Tesla.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("tesla")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("tesla")
